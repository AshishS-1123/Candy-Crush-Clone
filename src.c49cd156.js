...
function () {
  function SpritePool() {
    this.ImageLoaded = new _signalTs.Signal(); // Image for empty cell.
  ...
  SpritePool.prototype.handleImageLoad = function () {
...
var BOARD_WIDTH = Math.floor(Math.min(innerWidth * 0.8, 700) / totalWidth) * totalWidth;
exports.BOARD_WIDTH = BOARD_WIDTH;
var BOARD_HEIGHT = Math.floor(Math.min(innerHeight * 0.8, 700) / totalWidth) * totalWidth; // Rows and columns of candies

exports.BOARD_HEIGHT = BOARD_HEIGHT;
var ROWS = Math.floor((BOARD_HEIGHT - CELL_PADDING) / (CELL_HEIGHT + CELL_PADDING));
exports.ROWS = ROWS;
var COLUMNS = Math.floor((BOARD_WIDTH - CELL_PADDING) / (CELL_WIDTH + CELL_PADDING));
...
var MOVES = 10; // Colors supported for candies
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          _EventBus.Global.spritePool.ImageLoaded.add(function () {
            return _EventBus.EventBus.renderBoard.emit(board);
          });
...
//# sourceMappingURL=/Candy-Crush-Clone/src.c49cd156.js.map